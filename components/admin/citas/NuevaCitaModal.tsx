...
import { crearCita } from '@/app/admin/_actions/citas'
  ...
  return (
    <>
      ...
      <Modal
        ...
        description="Completa los datos del prospecto para agendar la cita."
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-4 flex justify-end gap-3 border-t border-[var(--line-soft)] mt-6">
            ...
            >
              {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Guardar Cita'}
            </button>
          </div>
        </form>
      </Modal>
